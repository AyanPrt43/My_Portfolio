...
export default function Navbar() {
  return (
    <nav className="flex items-center mobile-wrap" style={{ padding: '2rem 0' }}>
      <div style={{ flex: 1, flexBasis: 0 }}></div>
      
      <div className="flex gap-8 mobile-gap-4 text-sm font-medium" style={{ justifyContent: 'center' }}>
      ...
      <div className="flex items-center gap-6" style={{ flex: 1, flexBasis: 0, justifyContent: 'flex-end' }}>
