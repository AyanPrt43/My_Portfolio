...
function ThemeProvider(t0) {
    ...
    if ($[0] !== "374a2ff46fd3c138c2e2fe7d34df53c41d6e19dee580513d28368cecd0117d2a") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "374a2ff46fd3c138c2e2fe7d34df53c41d6e19dee580513d28368cecd0117d2a";
    }
    let children;
    let props;
    let t1;
    let t2;
    if ($[1] !== t0) {
        ({ children, defaultTheme: t1, storageKey: t2, ...props } = t0);
        $[1] = t0;
        $[2] = children;
        $[3] = props;
        $[4] = t1;
    ...
    const storageKey = t2 === undefined ? "theme" : t2;
    ...
    let t3;
    let t4;
    if ($[6] !== defaultTheme || $[7] !== storageKey) {
        t3 = ({
    ...
    let t8;
    if ($[15] !== resolvedTheme || $[16] !== t7 || $[17] !== theme) {
        t8 = {
            theme,
            resolvedTheme,
            setTheme: t7
    ...
    const value = t8;
    let t9;
    if ($[19] !== children || $[20] !== props || $[21] !== value) {
        t9 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ThemeProviderContext.Provider, {
            ...props,
            value: value,
            children: children
        }, void 0, false, {
...
_s(ThemeProvider, "0O/KQ5lWWl/BfJ0leynSmH8elrY=");
_c = ThemeProvider;
const useTheme = ()=>{
    _s1();
...
//# sourceMappingURL=_20ummeq._.js.map